...
const linkClass = ({ isActive }) =>
  classNames(
    "flex items-center justify-between gap-3 rounded-xl px-4 py-3 text-sm font-semibold transition focus:outline-none focus-visible:ring-4 focus-visible:ring-violet-100",
    isActive
  ...
  return (
    <div className="min-h-screen bg-transparent">
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col lg:flex-row">
        <aside className="border-b border-slate-200 bg-white/95 px-4 py-4 shadow-sm shadow-slate-200/60 lg:sticky lg:top-0 lg:h-dvh lg:w-72 lg:border-b-0 lg:border-r lg:px-5 lg:py-6">
          <div className="flex h-full flex-col gap-5">
            <div className="flex items-center justify-between gap-4">
              ...
              <button
                type="button"
                onClick={logout}
                className="rounded-full px-3 py-2 text-sm font-semibold text-slate-600 transition hover:bg-slate-100 hover:text-slate-950 focus:outline-none focus-visible:ring-4 focus-visible:ring-violet-100 lg:hidden"
              >
                Logout
              </button>
            </div>

            <nav className="grid gap-2 rounded-2xl bg-slate-100/80 p-1 ring-1 ring-slate-200/70 sm:grid-cols-3 lg:grid-cols-1">
            ...
            <div className="hidden rounded-2xl border border-slate-200 bg-slate-50/80 p-4 lg:block">
              ...
              <button
                type="button"
                onClick={logout}
                className="mt-4 w-full rounded-xl bg-white px-3 py-2 text-sm font-semibold text-slate-700 ring-1 ring-slate-200 transition hover:bg-slate-100 focus:outline-none focus-visible:ring-4 focus-visible:ring-violet-100"
              >
                Logout
              </button>
            </div>
          ...
          <header className="border-b border-slate-200 bg-white/80 px-4 py-4 shadow-sm shadow-slate-200/40 backdrop-blur sm:px-6 lg:px-8">
            <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <NavLink
                  to="/"
                  className="rounded-full px-3 py-1 text-xs font-semibold text-slate-500 transition hover:bg-slate-100 hover:text-slate-950 focus:outline-none focus-visible:ring-4 focus-visible:ring-violet-100 sm:hidden"
                >
                  Public app
                </NavLink>
              </div>
